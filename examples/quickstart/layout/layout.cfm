...
<style type="text/css" media="screen">@import url("js/syntaxhighlighter/styles/syntaxHighlighter.css");</style>
...
<div id="wrap">
	...
	<div id="header">
		...
		<ul id="nav">
		<li <cfif attributes.section eq "home">class="first active"<cfelse>class="first"</cfif>><a href="index.cfm">Home</a></li>
		<li <cfif attributes.section eq "intro">class="active"</cfif>><a href="intro/index.cfm">ColdSpring in 5 Minutes</a></li>
		<li <cfif attributes.section eq "factory">class="active"</cfif>><a href="factory/index.cfm">Factory Beans</a>
		<li <cfif attributes.section eq "aop">class="active"</cfif>><a href="aop/index.cfm">AOP Example</a></li>
		<li <cfif attributes.section eq "remote">class="active"</cfif>><a href="remote/index.cfm">Remote Proxies</a></li>
		</ul>
	</div>
