<cfcomponent output="false" displayname="LoggingAdvice" hint="I advise service layer methods and apply logging." implements="coldspring.aop.MethodInterceptor">
        ...
        <cffunction name="invokeMethod" returntype="any" access="public" output="false" hint="">
                ...
                <cfset local.logData.method = arguments.methodInvocation.getMethod().getName() />
