...
<link rel="stylesheet" type="text/css" href="/examples/css/main.css" media="screen" />
<link rel="stylesheet" type="text/css" href="/examples/css/print.css" media="print" />
<!--[if lte IE 6]>
<link rel="stylesheet" type="text/css" href="/examples/css/ie6_or_less.css" />
<![endif]-->
<script type="text/javascript" src="/examples/js/common.js"></script>

<!-- Include the SyntaxHighlighter stylesheet -->
<style type="text/css" media="screen">@import url("/examples/js/syntaxhighlighter/styles/syntaxHighlighter.css");</style>
<!-- Include the core SyntaxHighlighter library -->
<script language="javascript" src="/examples/js/syntaxhighlighter/scripts/shCore.js"></script>

<script language="javascript">
window.onload = function () {
 // Set the path to the flash component to enable 'copy to clipboard' in firefox
 dp.SyntaxHighlighter.ClipboardSwf = '/examples/js/syntaxhighlighter/scripts/clipboard.swf';
...
<script language="javascript" src="/examples/js/syntaxhighlighter/scripts/shBrushCss.js"></script>
<script language="javascript" src="/examples/js/syntaxhighlighter/scripts/shBrushJScript.js"></script>
<script language="javascript" src="/examples/js/syntaxhighlighter/scripts/shBrushSql.js"></script>
<script language="javascript" src="/examples/js/syntaxhighlighter/scripts/shBrushXml.js"></script>
<script language="javascript" src="/examples/js/syntaxhighlighter/scripts/shBrushColdFusion.js"></script>
...
<div id="wrap">
	...
	<div id="header">
		<div id="site-name" style="margin-bottom:10px">ColdSpring 2 Examples</div>
		<div id="search">
		</div>
		<ul id="nav">
		<li <cfif attributes.section eq "home">class="first active"<cfelse>class="first"</cfif>><a href="/examples/index.cfm">Home</a></li>
		<li <cfif attributes.section eq "intro">class="active"</cfif>><a href="/examples/intro/index.cfm">ColdSpring in 5 Minutes</a></li>
		<li <cfif attributes.section eq "factory">class="active"</cfif>><a href="/examples/factory/index.cfm">Factory Beans</a>
		<li <cfif attributes.section eq "aop">class="active"</cfif>><a href="/examples/aop/index.cfm">AOP Example</a></li>
		<li <cfif attributes.section eq "remote">class="active"</cfif>><a href="/examples/remote/index.cfm">Remote Proxies</a></li>
		</ul>
	</div>
