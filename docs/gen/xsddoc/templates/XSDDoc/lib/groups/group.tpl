...
<ROOT>
	...
	<FOLDER>
		...
		<BODY>
			...
			<TEMPLATE_CALL>
				...
				COND='getBooleanParam("doc.comp.xmlRep") &&\ngetBooleanParam("doc.comp.xmlRep.for.group")'
				<HTARGET>
					COND='output.type == "document"'
					HKEYS={
						'contextElement.id';
	...
	<FOLDER>
		DESCR='Annotation'
		COND='getBooleanParam("doc.comp.annotation") &&\ngetBooleanParam("doc.comp.annotation.for.group")'
		COLLAPSED
		<BODY>
			<TEMPLATE_CALL>
	...
	<TEMPLATE_CALL>
		...
		COND='getBooleanParam("doc.comp.contentElements") &&\ngetBooleanParam("doc.comp.contentElements.for.group")'
...
CHECKSUM='JCSln7fz?rMATHqCdwF5VnXeZ1wYNLBuDXv7tHS1O4A'
</DOCFLEX_TEMPLATE>