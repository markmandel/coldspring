					...
					<CTRL_GROUP>
						<CTRLS>
							...
							<DATA_CTRL>
								...
								<DOC_HLINK>
									TITLE_EXPR='instanceOf ("xs:complexType") ? "abstract complexType" : "abstract simpleType"'
									HKEYS={
										'contextElement.id';
										'"local"';
										'rootElement.id';
...
CHECKSUM='iN8a?uaVR0BxVLBzutEolrOT5F2rDaXRiuv6Gt0xRT8'
</DOCFLEX_TEMPLATE>