...
<TEMPLATE_PARAMS>
	...
	PARAM={
		...
		param.title='Names';
		param.description='This parameter allows you to specify directly the names of the elements to be documented in separate <b><i>Element Documentation</i></b> blocks.\n<p>\nThe elements should be specified with their local names (without namespace prefixes) separated with newlines or semicolons (\';\'). Only the element with the specified names will be documented.\n<p>\nWhen an element name is shared by several element components, including local ones, all of them are to be documented (according to the setting of <i>Local Elements</i> parameter).\n<p>\nWhen the list of names is empty (the parameter is not specified), all elements will be documented (considering other filtering criteria).';
		param.type='string';
		param.trimSpaces='true';
	...
	PARAM={
		...
		param.title='Names';
		param.description='This parameter allows you to specify directly the names of the global complex types to be documented in separate <b><i>Complex Type Documentation</i></b> blocks.\n<p>\nThese should be the local names (without namespace prefixes) of the complexType components separated with newlines or semicolons (\';\'). Only the types with the specified names will be documented.\n<p>\nWhen the list of names is empty (the parameter is not specified), all global complex types will be documented.';
		param.type='string';
		param.trimSpaces='true';
		param.collapseSpaces='true';
		param.noEmptyString='true';
	...
	PARAM={
		...
		param.title='Names';
		param.description='This parameter allows you to specify directly the names of the global simple types to be documented in separate <b><i>Simple Type Documentation</i></b> blocks.\n<p>\nThese should be the local names (without namespace prefixes) of the simpleType components separated with newlines or semicolons (\';\'). Only the types with the specified names will be documented.\n<p>\nWhen the list of names is empty (the parameter is not specified), all global simple types will be documented.';
		param.type='string';
		param.trimSpaces='true';
		param.collapseSpaces='true';
		param.noEmptyString='true';
	...
	PARAM={
		...
		param.title='Names';
		param.description='This parameter allows you to specify directly the names of the global element groups to be documented in separate <b><i>Element Group Documentation</i></b> blocks.\n<p>\nThese should be the local names (without namespace prefixes) of the element group components separated with newlines or semicolons (\';\'). Only the groups with the specified names will be documented.\n<p>\nWhen the list of names is empty (the parameter is not specified), all global element groups will be documented.';
		param.type='string';
		param.trimSpaces='true';
		param.collapseSpaces='true';
		param.noEmptyString='true';
	...
	PARAM={
		...
		param.title='Names';
		param.description='This parameter allows you to specify directly the names of the global attributes to be documented in separate <b><i>Attribute Documentation</i></b> blocks.\n<p>\nThese should be the local names (without namespace prefixes) of the attribute components separated with newlines or semicolons (\';\'). Only the attributes with the specified names will be documented.\n<p>\nWhen the list of names is empty (the parameter is not specified), all global attributes will be documented.';
		param.type='string';
		param.trimSpaces='true';
		param.collapseSpaces='true';
		param.noEmptyString='true';
	...
	PARAM={
		...
		param.title='Names';
		param.description='This parameter allows you to specify directly the names of the global attribute groups to be documented in separate <b><i>Attribute Group Documentation</i></b> blocks.\n<p>\nThese should be the local names (without namespace prefixes) of the attribute group components separated with newlines or semicolons (\';\'). Only the groups with the specified names will be documented.\n<p>\nWhen the list of names is empty (the parameter is not specified), all global attribute groups will be documented.';
		param.type='string';
		param.trimSpaces='true';
		param.collapseSpaces='true';
		param.noEmptyString='true';
	...
	PARAM={
		...
		param.title='All Component Summary';
		param.description='Specify whether <i>All Component Summary</i> documentation should start from a new page.\n<p>\n<b>See Also:</b>\n<ul>\n<li><i>Generate Details | All Component Summary</i></li>\n<li><i>Details | All Component Summary</i></li>\n</ul>';
		param.type='boolean';
		param.default.value='true';
	}
	PARAM={
	...
	PARAM={
		...
		param.title='Component Documentation';
		param.description='Specify if each <i>Component Documentation</i> should start from a new page.\n<p>\n<b>See Also:</b>\n<ul>\n<li>Corresponding parameters in <i>"Generate Details"</i> parameter group</li>\n<li><i>Details | Component Documentation</i></li>\n</ul>';
		param.type='boolean';
		param.default.value='true';
	}
	PARAM={
		...
		param.title='XML Namespace Bindings';
		param.description='Specify whether the <i>Namespace Bindings</i> report should start from a new page.\n<p>\n<b>See Also:</b>\n<blockquote>\n<i>Generate Details | XML Namespace Bindings</i>\n</blockquote>';
		param.type='boolean';
		param.default.value='true';
	}
	PARAM={
...
CHECKSUM='gwAaFbBwQyZn1xftyxECNVldPgoO7LtnTG00iq0Sbzk'
</DOCFLEX_TEMPLATE>