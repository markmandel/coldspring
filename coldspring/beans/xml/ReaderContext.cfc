...
<cffunction name="init" hint="Constructor" access="public" returntype="ReaderContext" output="false">
	...
	<cfargument name="xmlFileReader" hint="The xml file reader for the current xml document" type="coldspring.core.io.AbstractXMLReader" required="true">
...
<cffunction name="getXmlFileReader" hint="The xml file reader for the current xml document"
	access="public" returntype="coldspring.core.io.AbstractXMLReader" output="false">
...
<cffunction name="setXmlFileReader" access="private" returntype="void" output="false">
	<cfargument name="xmlFileReader" type="coldspring.core.io.AbstractXMLReader" required="true">
