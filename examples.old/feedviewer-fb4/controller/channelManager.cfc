...
<cfcomponent name="channelListener.cfc" output="false">
	<cffunction name="init" access="public" returntype="examples.feedviewer-fb4.controller.channelManager" output="false">
	...
	<cffunction name="getChannelById" returntype="examples.feedviewer.model.channel.channel" access="public" output="false" hint="I retrieve a channel">
