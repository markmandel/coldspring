...
<cfcomponent name="categoryManager.cfc" output="false">
	<cffunction name="init" access="public" returntype="examples.feedviewer-fb4.controller.categoryManager"  output="false">
	...
	<cffunction name="getCategoryById" access="public" returntype="examples.feedviewer.model.category.category" output="false" hint="I retrieve a category">
		<cfargument name="event" type="examples.feedviewer-fb4.plugins.event" required="yes" displayname="Event"/>
