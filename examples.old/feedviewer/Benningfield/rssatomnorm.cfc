<cfcomponent displayname="RSS/Atom Normalization 1.0" hint="Converts Atom and RSS 0.x/1.0/2.x feeds into a common structure." extends="examples.feedviewer.model.normalization.normalizationService">
