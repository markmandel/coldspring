...
<cfcomponent name="Normalization Service" hint="Uses Roger Benningfield's rssatomnormcfc"  extends="examples.feedviewer.model.normalization.normalizationService" output="false">
	
	<cffunction name="init" returntype="examples.feedviewer.model.normalization.benningfieldNormalizationService" access="public">
		<cfargument name="rssatomnormalizer" type="examples.feedviewer.Benningfield.rssatomnorm" required="true"/>
	...
	<cffunction name="setRetrievalService" returntype="void" access="public" output="false" hint="dependency: retrievalService">
		<cfargument name="retrievalService" type="examples.feedviewer.model.retrieval.retrievalService" required="true"/>
