...
<cfcomponent name="romeNormalizationService" output="false" extends="examples.feedviewer.model.normalization.normalizationService">
	
	
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.normalization.romeNormalizationService" output="false">
