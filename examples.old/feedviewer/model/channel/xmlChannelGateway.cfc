...
<cfcomponent name="XML Channel Gateway" extends="examples.feedviewer.model.channel.channelGateway" output="false">
	
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.channel.xmlChannelGateway">
