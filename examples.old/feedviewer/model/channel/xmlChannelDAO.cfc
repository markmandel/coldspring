...
<cfcomponent name="XML channel DAO" output="false" extends="examples.feedviewer.model.channel.channelDAO">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.channel.xmlChannelDAO">
