...
<cfcomponent name="MySQL channel DAO" output="false" extends="examples.feedviewer.model.channel.channelDAO">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.channel.sqlchannelDAO">
	...
	<cffunction name="fetch" returntype="examples.feedviewer.model.channel.channel" output="false" access="public" hint="I retrieve a channel">
		...
		<cfset var channel = createObject("component","examples.feedviewer.model.channel.channel").init()/>
	...
	<cffunction name="save" returntype="void" output="false" access="public" hint="I save a channel">
		<cfargument name="channel" type="examples.feedviewer.model.channel.channel" hint="I am the channel to be saved" required="true"/>
	...
	<cffunction name="remove" returntype="void" output="false" access="public" hint="I remove a channel">
		<cfargument name="channel" type="examples.feedviewer.model.channel.channel" hint="I am the channel to be removed" required="true"/>
