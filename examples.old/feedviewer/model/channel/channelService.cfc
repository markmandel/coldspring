...
<cfcomponent name="Channel Service" output="false">
	...
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.channel.channelService" output="false">
	...
	<cffunction name="setChannelDAO" returntype="void" access="public"	output="false" hint="dependency: channelDAO">
		<cfargument name="channelDAO" type="examples.feedviewer.model.channel.channelDAO"	required="true"/>
	...
	<cffunction name="setChannelGateway" returntype="void" access="public" output="false" hint="dependency: channelGateway">
		<cfargument name="channelGateway" type="examples.feedviewer.model.channel.channelGateway" required="true"/>
	...
	<cffunction name="getById" returntype="examples.feedviewer.model.channel.channel" access="public" output="false" hint="I retrieve a channel by id">
	...
	<cffunction name="save" returntype="void" access="public" output="false" hint="I save a channel">
		<cfargument name="channel" type="examples.feedviewer.model.channel.channel" required="true" hint="channel to save"/>
	...
	<cffunction name="remove" returntype="void" access="public" output="false" hint="I remove a channel">
		<cfargument name="channel" type="examples.feedviewer.model.channel.channel" required="true" hint="channel to remove"/>
