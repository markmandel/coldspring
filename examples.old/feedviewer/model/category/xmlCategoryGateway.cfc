...
<cfcomponent name="XML Category Gateway" extends="examples.feedviewer.model.category.categoryGateway" output="false">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.category.xmlCategoryGateway">
