...
<cfcomponent name="XML Category DAO" output="false" extends="examples.feedviewer.model.category.categoryDAO">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.category.xmlCategoryDAO">
		<cfargument name="datasourceSettings" type="examples.feedviewer.model.datasource.datasourceSettings" required="true"/>
		<cfset var cffile = 0/>
	...
	<cffunction name="setLogger" returntype="void" access="public" output="false" hint="dependency: logger">
		<cfargument name="logger" type="examples.feedviewer.model.logging.logger" required="true"/>
	...
	<cffunction name="fetch" returntype="examples.feedviewer.model.category.category" output="false" access="public" hint="I retrieve a category">
		<cfargument name="categoryIdentifier" type="any" required="true" hint="I am the unique ID of the category to be retrieved"/>
		<cfset var category = createObject("component","examples.feedviewer.model.category.category").init()/>
		<cfset var xmlCat = 0 />
	...
	<cffunction name="save" returntype="void" output="false" access="public" hint="I save a category">
		<cfargument name="category" type="examples.feedviewer.model.category.category" hint="I am the category to be saved" required="true"/>
	...
	<cffunction name="remove" returntype="void" output="false" access="public" hint="I remove a category">
		<cfargument name="category" type="examples.feedviewer.model.category.category" hint="I am the category to be removed" required="true"/>
		<cfset var idx = 0/>
		<cfset refreshXmlContent() />
