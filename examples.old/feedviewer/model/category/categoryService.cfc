...
<cfcomponent name="Category Service" output="false">
	...
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.category.categoryService" output="false">
	...
	<cffunction name="setCategoryDAO" returntype="void" access="public"	output="false" hint="dependency: categoryDAO">
		<cfargument name="categoryDAO" type="examples.feedviewer.model.category.categoryDAO"	required="true"/>
	...
	<cffunction name="setCategoryGateway" returntype="void" access="public" output="false" hint="dependency: categoryGateway">
		<cfargument name="categoryGateway" type="examples.feedviewer.model.category.categoryGateway" required="true"/>
	...
	<cffunction name="save" returntype="void" access="public" output="false" hint="I save a category">
		<cfargument name="category" type="examples.feedviewer.model.category.category" required="true"/>
