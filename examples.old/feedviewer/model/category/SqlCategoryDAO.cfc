...
<cfcomponent name="SQL Category DAO" output="false" extends="examples.feedviewer.model.category.categoryDAO">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.category.sqlCategoryDAO">
