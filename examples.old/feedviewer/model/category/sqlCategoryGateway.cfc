...
<cfcomponent name="MySql Category Gateway" extends="examples.feedviewer.model.category.categoryGateway" output="false">
	
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.category.sqlCategoryGateway">
