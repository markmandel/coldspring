...
<cfcomponent name="CFLOG Logger" output="false" extends="examples.feedviewer.model.logging.logger">
	...
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.logging.cfloglogger" output="false">
