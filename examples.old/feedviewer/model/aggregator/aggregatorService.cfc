...
<cfcomponent name="Aggregator Service" output="false">
	...
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.aggregator.aggregatorService" output="false">
	...
	<cffunction name="setNormalizationService" returntype="void" access="public"	output="false" hint="dependency: normalizationService">
		<cfargument name="normalizationService" type="examples.feedviewer.model.normalization.normalizationService"	required="true"/>
	...
	<cffunction name="setEntryService" returntype="void" access="public"	output="false" hint="dependency: entryService">
		<cfargument name="entryService" type="examples.feedviewer.model.entry.entryService" required="true"/>
	...
	<cffunction name="aggregateEntriesByChannel" returntype="void" access="public" output="false" hint="I aggregate and store all entries for a supplied channel">
		<cfargument name="channel" type="examples.feedviewer.model.channel.channel"	required="true"/>
		...
		<cfloop from="1" to="#arraylen(normalizedEntries)#" index="entryIndex">
			...
			<cfset variables.m_entryService.save(createObject('component','examples.feedviewer.model.entry.entry').init(argumentcollection=entryData))/>
	...
	<cffunction name="getById" returntype="examples.feedviewer.model.category.category" access="public" output="false" hint="I retrieve a category">
