...
<cfcomponent name="cfhttp Retrieval Service" extends="examples.feedviewer.model.retrieval.retrievalService" output="false">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.retrieval.cfhttpRetrievalService">
		<cfreturn this/>
	</cffunction>
