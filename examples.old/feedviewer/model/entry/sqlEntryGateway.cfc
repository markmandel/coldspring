...
<cfcomponent name="Sql entry Gateway" extends="examples.feedviewer.model.entry.entryGateway" output="false">
	
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.entry.sqlEntryGateway">
