...
<cfcomponent name="Entry Service" output="false">
	...
	<cffunction name="init" access="public" returntype="examples.feedviewer.model.entry.entryService" output="false">
	...
	<cffunction name="setEntryDAO" returntype="void" access="public"	output="false" hint="dependency: entryDAO">
		<cfargument name="entryDAO" type="examples.feedviewer.model.entry.entryDAO"	required="true"/>
	...
	<cffunction name="setEntryGateway" returntype="void" access="public" output="false" hint="dependency: entryGateway">
		<cfargument name="entryGateway" type="examples.feedviewer.model.entry.entryGateway" required="true"/>
	...
	<cffunction name="save" returntype="void" access="public"	output="false" hint="dependency: entryDAO">
		<cfargument name="entry" type="examples.feedviewer.model.entry.entry"	required="true"/>
