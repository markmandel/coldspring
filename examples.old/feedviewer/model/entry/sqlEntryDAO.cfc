...
<cfcomponent name="MySQL entry DAO" output="false" extends="examples.feedviewer.model.entry.entryDAO">
	
	<cffunction name="init" access="public" output="false" returntype="examples.feedviewer.model.entry.sqlEntryDAO">
	...
	<cffunction name="fetch" returntype="examples.feedviewer.model.entry.entry" output="false" access="public" hint="I retrieve a entry">
		...
		<cfset var entry = createObject("component","examples.feedviewer.model.entry.entry").init()/>
	...
	<cffunction name="save" returntype="void" output="false" access="public" hint="I save a entry">
		<cfargument name="entry" type="examples.feedviewer.model.entry.entry" hint="I am the entry to be saved" required="true"/>
	...
	<cffunction name="remove" returntype="void" output="false" access="public" hint="I remove a entry">
		<cfargument name="entry" type="examples.feedviewer.model.entry.entry" hint="I am the entry to be removed" required="true"/>
