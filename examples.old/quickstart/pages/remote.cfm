...
<p>
	...
	<a href="/examples/quickstart/components/RemoteLanguageService.cfc?wsdl" target="_blank">clicking here to view the WSDL for it</a>.
</p>
...
<cfinvoke 
	webservice="http://#cgi.server_name#:#cgi.server_port#/examples/quickstart/components/RemoteLanguageService.cfc?wsdl" 
